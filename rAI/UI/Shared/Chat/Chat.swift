...
struct Chat: View, Sendable {
    ...
    @State private var agentModelStore: AgentModelStore
    ...
    @AppStorage("defaultAgent") private var defaultAgent: String = ""
    @State var showMenu = false
    
    init(languageModelStore: LanguageModelStore, agentModelStore: AgentModelStore, conversationStore: ConversationStore, appStore: AppStore) {
        _languageModelStore = State(initialValue: languageModelStore)
        _agentModelStore = State(initialValue: agentModelStore)
