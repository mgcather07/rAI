...
struct ApplicationEntry: View {
    ...
    @State private var agentModelStore = AgentModelStore.shared
    ...
    var body: some View {
        VStack {
            ...
            case .chat:
                Chat(languageModelStore: languageModelStore, agentModelStore: agentModelStore, conversationStore: conversationStore, appStore: appStore)
            case .voice:
        ...
        .task {
            ...
            Task.detached {
                ...
                async let loadAgents: () = agentModelStore.loadAgents()
